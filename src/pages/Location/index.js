            ...
            <div className='container-fluid'>
                <nav className="navbar bg-light fixed-top">
                    ...
                    <div className="navbar-brand d-flex align-items-center">
                        ...
                        <div className='d-inline-block'>
                            <span className='d-block ms-3'><b>Locations</b></span>
                        </div>
                    </div>
                ...
                <div className='row py-4 mt-5 pt-5'>
                    ...
                    <div className='col-md-7 col-sm-12 ps-md-5 d-flex align-items-center justify-content-md-start justify-content-sm-center justify-content-center text-center text-md-start'>
                        <h1 className='text-light display-1 py-4 text-sm-center text-md-start fw-bold' style={{ backgroundColor: '#1b1b1b' }}>Rick and Morty<br /> Locations</h1></div>
                ...
                <div className='row mx-5'>
                    ...
                    {locations.map(location => (
                        ...
                        <div key={location.id} className="card p-0 mx-5 boxShadow border-0 mx-auto mt-md-5 mb-md-0 mb-5 w-100 col-3" style={{ maxWidth: "400px" }}>
                            <div className="row g-0">
                                <div className="col-md-12">
                                    <div className="card-body ms-2" >
                                        <h3 className="card-title mt-2"><strong>{location.name}</strong></h3>
                                        <p className='card-text mt-4 mb-1'><small className="text-body-secondary">Type:</small></p>
                                        <h6 className="card-text">{location.type}</h6>
                                        <p className='card-text mt-4 mb-1'><small className="text-body-secondary">Dimension:</small></p>
                                        <h6 className="card-text">{location.dimension}</h6>
                ...
                {hasNextPage && status !== "loading" && <div className='row my-5  d-flex justify-content-center align-content-center'>
                    <button className='btn btn-light w-25' onClick={() => dispatch(fetchLocations(num))}>Load More</button>
                </div>}
